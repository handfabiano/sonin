      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-serif font-bold">Sonin</h3>
            <p className="text-primary-200 text-sm">
              Velas aromáticas e óleos essenciais para transformar seu ambiente em um refúgio de bem-estar.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/produtos" className="text-primary-200 hover:text-white transition-colors">
                  Produtos
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-primary-700 mt-8 pt-8 text-center text-sm text-primary-300">
          <p>&copy; {new Date().getFullYear()} Sonin. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
